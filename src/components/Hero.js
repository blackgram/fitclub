  ...
  return (
    ...
    <div class="flex justify-center items-center w-full mt-[1rem] mt-[3rem]">
      <div class="flex justify-center items-center flex-col xl:max-w-[630px] lg:max-w-[506px] md:max-w-[335px] max-w-[250px]">
        ...
        <h1 class=" xl:text-[150px] font-bold text-transparent 
        ...
        <div class="flex items-center justify-center text-center">
          <div class="flex items-center justify-center text-center flex-col mx-[20px] md:mx-[10px]">
            <h4 class="font-bold text-[24px] md:text-[20px]">140+</h4>
          ...
          <div class="mx-[20px] flex items-center justify-center text-center flex-col md:mx-[10px]">
            <h4 class="font-bold text-[24px] md:text-[20px]">978+</h4>
            <p class="text-[12px] md:text-[10px]">Members Joined</p>
          </div>
          <div class="flex items-center justify-center text-center flex-col mx-[20px] md:mx-[10px]">
            <h4 class="font-bold text-[24px] md:text-[20px]">50+</h4>
     ...
     <div class="flex flex-col bg-grayish md:absolute right-[3vw] z-10 xl:w-[200px] lg:w-[160px] xl:h-[120px] lg:h-[110px]  
        ...
        <div class="flex justify-between items-end h-[100%] w-full ">
          <div class="flex items-end mx-[6px] mb-[10px]">
            ...
            />
            <img alt="" src="/assets/grouped/Group7.png" class="xl:h-[50px] lg:h-[30px] h-[24px]" />
          </div>
          <div class="w-[55%]  mb-[6px]">
            <p class="xl:text-[12px] lg:text-[10px] text-[8px]">Calories Burned</p>
            <h4 class="xl:text-[16px] lg:text-[14px] font-bold text-[12px]">220 kcal</h4>
          </div>
        </div>
      </div>
      <div class="flex flex-col bg-grayish md:absolute lg:right-[3vw] xl:w-[200px] lg:w-[160px] xl:h-[120px] lg:h-[110px]
        ...
        <div class="flex justify-between items-end h-[100%] w-full ">
          ...
          <div class="w-[55%]  mb-[6px]">
            ...
            <h4 class="xl:text-[16px] lg:text-[14px] font-bold text-[12px]">116 bpm</h4>
          </div>
        </div>
      </div>
     </div>
